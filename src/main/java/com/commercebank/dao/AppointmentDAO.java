...
public class AppointmentDAO {
    ...
    public int findId(){
        List<Appointment> appointments = this.jdbcTemplate.query("SELECT * FROM appointment ORDER BY id DESC LIMIT 1", appointmentMapper);
        int id = appointments.get(0).getId();
        return id;
    }
